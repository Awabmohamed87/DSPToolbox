...
namespace DSPComponentsUnitTest
{
    ...
    public class MovingAverageTestCases
    {
        ...
        public void MovingAverageTestMethod1()
        {
            ...
            a.Run();
            Console.WriteLine(expectedOutput.Count + " " + a.OutputAverageSignal.Samples.Count);
            for (int i = 0; i < a.OutputAverageSignal.Samples.Count; i++)
                Console.WriteLine(expectedOutput[i] + " " + a.OutputAverageSignal.Samples[i]);
        ...
        public void MovingAverageTestMethod2()
        {
            ...
            a.Run();
            Console.WriteLine(sig1.Samples.Count + " " + a.OutputAverageSignal.Samples.Count);
            Assert.IsTrue(UnitTestUtitlities.SignalsSamplesAreEqual(expectedOutput, a.OutputAverageSignal.Samples));
        }
    }
}
